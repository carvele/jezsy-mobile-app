...
7. ~~**Occlusion is inactive**~~ — **closed** (roadmap Phase 2 Tier 1). The capsule shader, full-screen quad, per-frame joint uniforms, and `scene.add(occlusionMesh)` are all live in `GarmentRenderer.tsx`.
