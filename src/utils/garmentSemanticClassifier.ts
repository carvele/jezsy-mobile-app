...
const DRESS_SUBTYPES: SubtypeRow[] = [
  ...
  { pattern: /\bdress\b(?!\s+(?:pants?|trousers?|slacks?|shirts?|shoes?|boots?|flats?|code|socks?|vest|belt))\b/i, type: 'Dress', subtype: null },
...
const FOOTWEAR_SUBTYPES: SubtypeRow[] = [
  ...
  { pattern: /\bdress\s+shoes?\b/i,                type: 'Shoes',   subtype: 'Dress Shoes' },
...
const BOTTOM_SUBTYPES: SubtypeRow[] = [
  ...
  { pattern: /\bdress\s+(?:pants?|trousers?|slacks?)\b/i, type: 'Trousers', subtype: 'Dress Trousers' },
...
const TOP_SUBTYPES: SubtypeRow[] = [
  ...
  { pattern: /\bdress\s+shirts?\b/i,                type: 'Shirt',    subtype: 'Dress Shirt' },
