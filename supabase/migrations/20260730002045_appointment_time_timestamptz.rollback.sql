-- Rollback for 20260730031500_appointment_time_timestamptz.sql.
--
-- Restores the ::time casts from 20260722011025 (create_reservation),
-- 20260724094922 (reschedule_reservation) and 20260701110000
-- (validate_reservation_time). Note this puts customer reservations back in
-- the broken 42804 state -- only useful if the forward migration itself
-- misbehaves.
