-- Removes the multi-item entry point and restores create_reservation to its
-- pre-migration body (no reservation_items insert). Run this before the
-- reservation_items rollback if reverting both.
