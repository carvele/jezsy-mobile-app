-- Restores create_order to COALESCE(sale_price, price, 0) (pre-fix
-- behavior), matching the version created in this repo before
-- 20260722015141_order_respect_sale_price.sql.
